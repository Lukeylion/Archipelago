...
def did_include_extra_locations(world: "BioshockInfiniteWorld") -> bool:
...
def get_total_locations(world: "BioshockInfiniteWorld") -> int:
...
def is_valid_location(world: "BioshockInfiniteWorld", name) -> bool:
    if not did_include_extra_locations(world) and name in extra_locations:
        return False
