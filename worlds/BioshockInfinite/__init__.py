...
from .Options import BioshockInfiniteOptions
...
class BioshockInfiniteWeb(WebWorld):
...
class BioshockInfiniteWorld(World):
    """
    ...
    options_dataclass = BioshockInfiniteOptions
    options = BioshockInfiniteOptions
